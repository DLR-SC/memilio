...
#ifndef MIO_SDE_UI3_PARAMETERS_H
#define MIO_SDE_UI3_PARAMETERS_H
...
using ParametersBase = ParameterSet<TransmissionProbabilityOnContactV1, TransmissionProbabilityOnContactV2, TransmissionProbabilityOnContactV3,
                                    TimeInfectedV1, TimeInfectedV2, TimeInfectedV3, ProbMutation, ContactPatterns>;
